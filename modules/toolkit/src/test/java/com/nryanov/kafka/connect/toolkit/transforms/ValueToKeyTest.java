...
public class ValueToKeyTest {
    ...
    public void copyAllFields() {
        ...
        var expectedKeySchema = SchemaBuilder
                .struct()
                .field("a", Schema.STRING_SCHEMA)
                .field("b_key", Schema.INT32_SCHEMA)
                .field("c_key", Schema.STRING_SCHEMA)
                .build();

        var expectedKeyStruct = new Struct(expectedKeySchema)
                .put("a", "a_field_value")
                .put("b_key", 1)
                .put("c_key", "c_field_value");
    ...
    public void copyNestedFields() {
        ...
        var expectedNestedStructSchema = SchemaBuilder
                .struct()
                .field("inner_struct_a_key", Schema.OPTIONAL_INT64_SCHEMA)
                .field("inner_struct_b_key", Schema.OPTIONAL_STRING_SCHEMA)
                .field("inner_struct_c_key", Schema.INT32_SCHEMA)
                .optional()
                .build();
        var expectedKeySchema = SchemaBuilder
                .struct()
                .field("id", Schema.STRING_SCHEMA)
                .field("array_key", SchemaBuilder.array(expectedNestedArrayStructSchema).build())
        ...
        var expectedNestedStruct = new Struct(expectedNestedStructSchema)
                .put("inner_struct_a_key", 64L)
                .put("inner_struct_b_key", "inner_struct_b_value")
                .put("inner_struct_c_key", 32);
        var expectedKeyStruct = new Struct(expectedKeySchema)
                .put("id", "some id")
                .put("array_key", List.of(expectedNestedArrayStruct1, expectedNestedArrayStruct2))
