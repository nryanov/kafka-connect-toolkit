...
public class BytesToBase64Test {
    ...
    public void correctlyHandleNullPayload() {
        var transform = new BytesToBase64.Key<SinkRecord>();
    ...
    @Test
    public void encodeBytesToBase64StringInKey() {
        var transform = new BytesToBase64.Key<SinkRecord>();
        transform.configure(Map.of(
                "fields", "field_1"
        ));
        ...
        var expectedStruct = new Struct(expectedSchema).put("field_1", "ZmllbGRfMV92YWx1ZQ==").put("field_2", string2bytes("field_2_value"));
    ...
    @Test
    public void encodeBytesToBase64StringInValue() {
        var transform = new BytesToBase64.Value<SinkRecord>();
        transform.configure(Map.of(
                "fields", "field_1"
        ));
    ...
    public void encodeAllFieldsToBase64() {
        ...
        var expectedStruct = new Struct(expectedSchema).put("field_1", "ZmllbGRfMV92YWx1ZQ==").put("field_2", "ZmllbGRfMl92YWx1ZQ==");

        assertEquals(expectedSchema, expectedStruct.schema());
        assertEquals(resultStruct, expectedStruct);
    }
