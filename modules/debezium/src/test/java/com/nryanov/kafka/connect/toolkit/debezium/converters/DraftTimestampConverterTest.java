...
public class DraftTimestampConverterTest {
    ...
    @CsvSource(delimiter = ',', quoteCharacter = '*', textBlock = """
            ...
            optional_time_no_tz,                    *TIME WITHOUT TIME ZONE*,                                           *'12:00:00'*,               *12:00:00.000*,                 *[UNKNOWN]*
            optional_time_no_tz_with_default,       *TIME WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP*,                 *'12:00:00'*,               *12:00:00.000*,                 *[UNKNOWN]*
            required_time_no_tz,                    *TIME WITHOUT TIME ZONE NOT NULL*,                                  *'12:00:00'*,               *12:00:00.000*,                 *[UNKNOWN]*
            required_time_no_tz_with_default,       *TIME WITHOUT TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP*,        *'12:00:00'*,               *12:00:00.000*,                 *[UNKNOWN]*
            optional_time_tz,                       *TIME WITH TIME ZONE*,                                              *'12:00:00'*,               *12:00:00.000*,                 *[UNKNOWN]*
            optional_time_tz_with_default,          *TIME WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP*,                    *'12:00:00'*,               *12:00:00.000*,                 *[UNKNOWN]*
            required_time_tz,                       *TIME WITH TIME ZONE NOT NULL*,                                     *'12:00:00'*,               *12:00:00.000*,                 *[UNKNOWN]*
            required_time_tz_with_default,          *TIME WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP*,           *'12:00:00'*,               *12:00:00.000*,                 *[UNKNOWN]*
            """)
