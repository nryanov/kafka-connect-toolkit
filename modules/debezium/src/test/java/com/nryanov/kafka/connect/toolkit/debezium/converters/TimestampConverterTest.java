...
public class TimestampConverterTest {
    ...
    @CsvSource(delimiter = ',', quoteCharacter = '*', textBlock = """
            # CASE                                  JDBC_TYPE                                                           VALUE                             EXPECTED_VALUE                  EXPECTED_AVRO_TYPE                                                                                                                                              SNAPSHOT
            optional_timestamp_tz,                  *TIMESTAMP WITH TIME ZONE*,                                         *'2025-01-01 12:00:00+03:00'*,    *1735722000000*,                *["null",{"type":"long","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Timestamp","logicalType":"timestamp-millis"}]*,                       NONE
            optional_timestamp_tz_with_default,     *TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP*,               *'2025-01-01 12:00:00+03:00'*,    *1735722000000*,                *[{"type":"long","connect.version":1,"connect.default":0,"connect.name":"org.apache.kafka.connect.data.Timestamp","logicalType":"timestamp-millis"},"null"]*,   NONE
            required_timestamp_tz,                  *TIMESTAMP WITH TIME ZONE NOT NULL*,                                *'2025-01-01 12:00:00+03:00'*,    *1735722000000*,                *["null",{"type":"long","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Timestamp","logicalType":"timestamp-millis"}]*,                       NONE
            required_timestamp_tz_with_default,     *TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP*,      *'2025-01-01 12:00:00+03:00'*,    *1735722000000*,                *[{"type":"long","connect.version":1,"connect.default":0,"connect.name":"org.apache.kafka.connect.data.Timestamp","logicalType":"timestamp-millis"},"null"]*,   NONE
            optional_timestamp_tz_blocking,         *TIMESTAMP WITH TIME ZONE*,                                         *'2025-01-01 12:00:00+03:00'*,    *1735722000000*,                *["null",{"type":"long","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Timestamp","logicalType":"timestamp-millis"}]*,                       BLOCKING
            optional_timestamp_tz_incremental,      *TIMESTAMP WITH TIME ZONE*,                                         *'2025-01-01 12:00:00+03:00'*,    *1735722000000*,                *["null",{"type":"long","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Timestamp","logicalType":"timestamp-millis"}]*,                       INCREMENTAL
            """)
    ...
    @CsvSource(delimiter = ',', quoteCharacter = '*', textBlock = """
            # CASE                                  JDBC_TYPE                                                           VALUE                       EXPECTED_VALUE                  EXPECTED_AVRO_TYPE                                                                                                              SNAPSHOT
            optional_time_tz,                       *TIME WITH TIME ZONE*,                                              *'12:00:00+03:00'*,         *32400000*,                     *["null",{"type":"int","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Time","logicalType":"time-millis"}]*,  NONE
            optional_time_tz_with_default,          *TIME WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP*,                    *'12:00:00+03:00'*,         *32400000*,                     *["null",{"type":"int","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Time","logicalType":"time-millis"}]*,  NONE
            required_time_tz,                       *TIME WITH TIME ZONE NOT NULL*,                                     *'12:00:00+03:00'*,         *32400000*,                     *["null",{"type":"int","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Time","logicalType":"time-millis"}]*,  NONE
            required_time_tz_with_default,          *TIME WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP*,           *'12:00:00+03:00'*,         *32400000*,                     *["null",{"type":"int","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Time","logicalType":"time-millis"}]*,  NONE
            optional_time_tz_blocking,              *TIME WITH TIME ZONE*,                                              *'12:00:00+03:00'*,         *32400000*,                     *["null",{"type":"int","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Time","logicalType":"time-millis"}]*,  BLOCKING
            optional_time_tz_incremental,           *TIME WITH TIME ZONE*,                                              *'12:00:00+03:00'*,         *32400000*,                     *["null",{"type":"int","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Time","logicalType":"time-millis"}]*,  INCREMENTAL
            """)
    ...
    @CsvSource(delimiter = ',', quoteCharacter = '*', textBlock = """
            ...
            custom_output_type_timestamp_tz,                  *TIMESTAMP WITH TIME ZONE*,                                         *'2025-01-01 12:00:00+03:00'*,    *2025-01-01T09:00:00.000Z*,       *["null","string"]*
            custom_output_type_timestamp_tz_with_default,     *TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP*,               *'2025-01-01 12:00:00+03:00'*,    *2025-01-01T09:00:00.000Z*,       *[{"type":"string","connect.default":"1970-01-01T00:00:00.000Z"},"null"]*
            ...
            custom_output_type_time_tz,                       *TIME WITH TIME ZONE*,                                              *'12:00:00+03:00'*,               *09:00:00.000Z*,                  *["null","string"]*
            custom_output_type_time_tz_with_default,          *TIME WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP*,                    *'12:00:00+03:00'*,               *09:00:00.000Z*,                  *["null","string"]*
            """)
    ...
    @CsvSource(delimiter = ',', quoteCharacter = '*', textBlock = """
            ...
            custom_pattern_timestamp_tz,                      *TIMESTAMP WITH TIME ZONE*,                                         *'2025-01-01 12:00:00+03:00'*,    *2025-01-01Z*,                    *["null","string"]*
            custom_pattern_date,                              *DATE*,                                                             *'2025-01-01'*,                   *01-01*,                          *["null","string"]*
            custom_pattern_time_no_tz,                        *TIME WITHOUT TIME ZONE*,                                           *'12:00:00'*,                     *00:00*,                          *["null","string"]*
            custom_pattern_time_tz,                           *TIME WITH TIME ZONE*,                                              *'12:00:00+03:00'*,               *09:00Z*,                         *["null","string"]*
            """)
    ...
    @CsvSource(delimiter = ',', quoteCharacter = '*', textBlock = """
            ...
            array_optional_timestamp_tz,                                *TIMESTAMP WITH TIME ZONE[]*,                                         *ARRAY[TIMESTAMPTZ '2025-01-01 12:00:00+03:00']*,     *[1735722000000]*,                *["null",{"type":"array","items":["null",{"type":"long","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Timestamp","logicalType":"timestamp-millis"}]}]*
            ...
            array_required_timestamp_tz,                                *TIMESTAMP WITH TIME ZONE[] NOT NULL*,                                *ARRAY[TIMESTAMPTZ '2025-01-01 12:00:00+03:00']*,     *[1735722000000]*,                *["null",{"type":"array","items":["null",{"type":"long","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Timestamp","logicalType":"timestamp-millis"}]}]*
            ...
            array_optional_time_tz,                                     *TIME WITH TIME ZONE[]*,                                              *ARRAY[TIMETZ '12:00:00+03:00']*,                     *[32400000]*,                     *["null",{"type":"array","items":["null",{"type":"int","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Time","logicalType":"time-millis"}]}]*
            ...
            array_required_time_tz,                                     *TIME WITH TIME ZONE[] NOT NULL*,                                     *ARRAY[TIMETZ '12:00:00+03:00']*,                     *[32400000]*,                     *["null",{"type":"array","items":["null",{"type":"int","connect.version":1,"connect.name":"org.apache.kafka.connect.data.Time","logicalType":"time-millis"}]}]*
            """)
